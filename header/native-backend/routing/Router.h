...
namespace nvb{
    ...
    public:
        Router() = default;
        void addRoute(HttpVerb::Verb verb, std::string path, std::function<boost::shared_ptr<HtmlPackage>(boost::shared_ptr<nvb::RequestInformation>)> builder);
        boost::shared_ptr<HtmlPackage> evaluateRoute(boost::shared_ptr<nvb::RequestInformation>);
    private:
        ...
        std::unordered_map<std::string,
                std::unordered_map<HttpVerb::Verb,
                        std::function<
                                boost::shared_ptr<nvb::HtmlPackage>(boost::shared_ptr<nvb::RequestInformation>)>>> routes_map_;
    };
}
